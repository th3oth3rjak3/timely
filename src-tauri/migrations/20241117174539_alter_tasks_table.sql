...
SELECT id, title, description, status, scheduled_start_date, scheduled_complete_date, actual_start_date, actual_complete_date, last_resumed_date, estimated_duration
FROM tasks;
