...
export type Task = {
  ...
  tags: Tag[];
  /** Work history associated with the current task. */
  workHistory: TaskWorkHistory[];
};

export type TaskWorkHistory = {
  id: number;
  taskId: number;
  startDate: Date;
  endDate: Date;
...
export type NewTaskWorkHistory = {
  taskId: number;
  startDate: Date;
  endDate: Date;
};

export type EditTaskWorkHistory = {
  id: number;
  taskId: number;
  startDate: Date;
  endDate: Date;
